...
// Use the exact connection string you provided
const MONGODB_URI = "mongodb+srv://Vercel-Admin-atlas-lightBlue-book:5scP865PtNLctb4k@atlas-lightblue-book.mfbxilu.mongodb.net/?retryWrites=true&w=majority";

async function setupDatabase() {
  let client;
  
  try {
    console.log('🚀 MongoDB Database Setup');
    console.log('==========================');
    console.log('📡 Connecting to MongoDB Atlas...');
    console.log('URI:', MONGODB_URI.replace(/5scP865PtNLctb4k/, '***'));
