...
async function setupDatabase() {
  ...
  try {
    ...
    const MONGODB_URI = `mongodb+srv://Vercel-Admin-atlas-lightBlue-book:${password}@atlas-lightblue-book.mfbxilu.mongodb.net/`;
    ...
    console.log('\n💡 Make sure to:');
    console.log('   1. Enter the correct MongoDB password');
